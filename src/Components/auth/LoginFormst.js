...
class LoginFormst extends Component{
                                ...
                                <div className="csignuppage">
                                    ...
                                    <div className="csignupform">
                                        ...
                                        <Form.Group as={Row} controlId="formPlaintextEmail">
                                            ...
                                            <Col sm="10">
                                                <Form.Control type="email" placeholder="Login" name="login" onChange={this.changeStockName.bind(this)} onKeyPress={this.pressEnter.bind(this)} />
                                            </Col>
                                        </Form.Group>
